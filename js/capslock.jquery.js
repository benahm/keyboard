...
; // Just in case the previously included plug-in failed to close with a
// semi-colon.
	...
	function check_caps_lock(e) {
		...
		if(upper !== lower) {
			...
			if( letter === upper && !shift_key ) {
				...
				$.fn.capslock.defaults.caps_lock_off();
			} else if( letter === lower && shift_key) {
				...
				if( navigator.platform.toLowerCase().indexOf("win") !== -1 ) {
					...
					if( navigator.platform.toLowerCase().indexOf("mac") !== -1
						...
						$.fn.capslock.defaults.caps_lock_off();
						 ...
						 $.fn.capslock.defaults.caps_lock_undetermined();
					}
				}
	...
	$.fn.capslock.defaults = {
		caps_lock_on:	function() {capsLock="on";$("#key_caps_lock").addClass("pressed");},
		caps_lock_off:	function() {capsLock="off";$("#key_caps_lock").removeClass("pressed");},
